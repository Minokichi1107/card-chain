...
function startDoubleUp() {
  ...
  if (document.getElementById("gameOverScreen").classList.contains("show")) duFromScreen = "gameOver";
  else if (document.getElementById("clearScreen").classList.contains("show")) duFromScreen = "clear";
